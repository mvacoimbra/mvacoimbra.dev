...
export default function ContactForm() {
  ...
  return (
    ...
    >
      ...
      <button
        type='submit'
        className={`text-black ${isValid ? 'bg-synth-green1 border-2 border-synth-green1' : 'bg-synth-neutral3 border-2 border-synth-neutral4'} rounded-full py-1 text-lg w-fit px-10 flex gap-2 items-center`}
        // disabled={!isValid}
      >
        <span>{'Enviar'}</span>

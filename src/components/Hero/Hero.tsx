...
export default function Hero() {
  return (
    <Section
      id='home'
      className="bg-[url('https://res.cloudinary.com/mvacoimbra/image/upload/v1713044471/mvacoimbra-porfolio/hero-bg.png')] py-3 px-[100px] relative max-sm:px-[20px] overflow-hidden bg-no-repeat bg-center flex justify-center items-center bg-cover h-screen w-full bg-fixed"
    >
